...
const Quizzes: React.FC<Props> = ({ userData, showQuiz = false }) => {
    ...
    return (
        <>
            {!showQuiz && (
                <div className="px-0 md:px-0 sm:px-28 pt-8 pb-4 flex justify-between items-center">
                    <div>
                        <input
                            type="radio"
                            id="onlyMe"
            ...
            <div className="w-full min-h-screen bg-white min-h-0">
                ...
                <main className="">
                    ...
                    <div className="mt-12 w-[90%] text-black flex flex-col">
                        ...
                        <div className="mt-4 flex justify-center items-center font-bold">
                            <span className="w-[10rem] text-right">Total Questions:</span>
                            <input
                                className="w-12 text-center border-2 border-gray-300 rounded-md ml-2"

...
const TaskSharing = () => {
  ...
  const handleAnswerSubmit = () => {
    if (
      currentAnswer.trim().toLowerCase() === task?.action.trim().toLowerCase()
    ) {
            ...
            <div className="w-full">
              <main className="p-6">
                <section className="flex mb-6 justify-between">
                  <h2 className="text-lg text-black font-semibold underline cursor-pointer">
                    Quiz
                  </h2>
                ...
                <div className="mt-12 text-center text-black">
                  <p>
                    ...
                    /
                    <input
                      className="ml-1 w-12 text-center border-2 border-gray-300 rounded-md"

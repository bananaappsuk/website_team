...
const OtherProfile = () => {
  return (
    <div className="min-h-screen bg-gray-100">
      <div className="flex flex-col lg:flex-row w-full">
        ...
        <div className="w-full lg:w-[100%] bg-white shadow-md p-4">
          {/* Header */}
          <div className="p-4 flex justify-between"><div className="text-start"><h1 className="text-[10px] sm:text-md md:text-md lg:text-2xl xl:text-3xl font-bold text-[#68A86B]"><a href="/Homepage">T-askLearn</a></h1><p className="text-[2px] sm:text-[4px] lg:text-[6px] xl:text-[8px] text-[#68A86B]"><a href="/Homepage">Collaborate to Learn, Learn to Collaborate</a></p></div><div className="px-4 text-black font-bold items-center flex justify-end gap-2"><a href="/Homepage">H</a><a href="/UserProfile">P</a></div></div>
          <div className="h-[1px] w-full bg-gray-300"></div>
          {/* User Info */}
          <div className="flex flex-col lg:flex-row mt-4">
            <div className="w-full lg:w-1/3 p-4">
            <img src="assets/Ellipse_2.png" className="m11_1" alt="Profile" />
              <p className="text-lg font-bold">Username, Job Role</p>
            </div>
            <div className="ml-auto flex items-center">
              <button className="re_1 text-white px-4 py-2 rounded mb1_1">Follow</button>
            </div>
          </div>
        
          {/* Main Quiz Section */}
          <div className="min-h-screen p-4 P1_1">
      {/* Quiz Header */}
      ...
      <div className="flex justify-center mt-4 gap-8">
        <button className="text-red-600 flex items-center">
          <img src="assets/image_2.png" alt="Cross" className="h-8 w-8" /> {/* Add correct icon path */}
        </button>
        <button className="text-green-600 flex items-center">
          <img src="assets/image_1.png" alt="Check" className="h-8 w-8" /> {/* Add correct icon path */}
        </button>
      </div>
      ...
      <div className="bg-white rounded-md shadow-md p-4 mt-4">
        ...
        <button className="text-[#67A76B] font-bold underline w-full px-10 py-6 border shadow-sm">CLICK TO REVEAL ANSWER</button>
      </div>

      {/* Icons Section */}
      <div className="flex justify-center mt-4 gap-8">
        <button className="text-red-600 flex items-center">
          <img src="assets/Vector_1.png" alt="Clear" className="h-8 w-8" /> {/* Add correct icon path */}
        </button>
        <button className="text-green-600 flex items-center">
          <img src="assets/Vector_2.png" alt="Submit" className="h-8 w-8" /> {/* Add correct icon path */}
        </button>
      </div>
    ...
    <div className="min_h1 p-4 shadow-lg border-2 rounded-lg p-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 text-center">
        ...
        <div className="bg-white p-4 shadow-md rounded-md">
          ...
          <div className="border mb-4 p-2 h-24"> {/* Add qualification details here */}</div>

          <h3 className="text-lg font-bold border-b pb-2 mb-4">Career Aspirations</h3>
          <div className="border p-2 h-24"> {/* Add career aspirations details here */}</div>
        </div>
      </div>
    </div>

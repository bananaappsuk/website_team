        ...
        <>
            ...
            >
                ...
                <div className='mt-8 sm:mt-12 flex flex-col items-center px-4 sm:px-8'>
                    <div className="bg-white shadow-lg rounded-lg pt-8 sm:pt-12 px-6 sm:px-12 pb-12 sm:pb-24 w-full sm:w-[60%]">
                        <h1 className="text-5xl sm:text-5xl font-normal text-center text-[#68A86B] mb-0">T-askLearn</h1>
                        <p className="text-center text-xs sm:text-xs text-[#68A86B] font-normal mb-8 sm:mb-16">Collaborate to Learn, Learn to Collaborate</p>
                        <form onSubmit={handleSubmit}>
                        <div className="fp_3">
                            <img src="assets/arrow_back.png" className="w-6 h-6 cn_1"/>
                        <label className="text-left text-xs sm:text-xs text-[#68A86B] font-normal mb-8 sm:mb-16">Back to Sign in</label></div>
                            <div className="flex flex-col sm:flex-row mb-6">
                                
                                <label htmlFor="email" className="sm:w-[50%] mb-2 sm:mb-0 text-[#646161]">
                            ...
                            <div className='flex flex-col justify-center items-center gap-8'>
                                <button
                                    type="submit"
                                    className="w-[33%] lg:w-[33%] bg-[#68A86B] border border-[#68A86B] text-white py-1 rounded-lg hover:bg-green-100 hover:text-black transition duration-300">Confirm                       
                                </button>
